  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-6 flex justify-between items-center mix-blend-exclusion text-white pointer-events-none">
        ...
        <div className="pointer-events-auto hidden md:flex items-center gap-8 mr-2">
          ...
          {/* Social Icons */}
          <div className="flex items-center gap-5 pl-7 border-l border-white/20">
            <a
              href="https://github.com/pramanikankush"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/ankush-pramanik-853565259/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="hover:text-brand-orange transition-colors duration-300"
